...
<head>
    ...
    <title>Halaman Tidak Ditemukan - Kas Management</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full text-center">
            ...
            <div class="mb-8">
                <div class="w-32 h-32 mx-auto bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20">
                    <div class="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center">
                        <img src="/money-transfer.png" alt="Kas Management" class="w-12 h-12 filter brightness-0 invert">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                ...
                <h2 class="text-2xl font-semibold text-white mb-4">Halaman Tidak Ditemukan</h2>
